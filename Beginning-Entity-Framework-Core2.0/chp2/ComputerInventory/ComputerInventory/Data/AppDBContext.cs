...
namespace ComputerInventory.Data
{
	...
	{
		public virtual DbSet<Machine> Machine { set; get; }

		public virtual DbSet<MachineType> MachineType { set; get; }
		
		public virtual DbSet<MachineWarranty> MachineWarranty { set; get; }

		public virtual DbSet<OperatingSys> OperatingSys { set; get; }

		public virtual DbSet<SupportLog> SupportLog { set; get; }

		public virtual DbSet<SupportTicket> SupportTicket { set; get; }

		public virtual DbSet<WarrantyProvider> WarrantyPrivider { set; get; }

		protected override void OnConfiguring(DbContextOptionsBuilder optionBuilder)
		{
			if (!optionBuilder.IsConfigured)
			{
				/*NB: Sensitive credential in the connection string should not be hard coded in production application */				
				optionBuilder.UseSqlServer(@"Data Source=CHUCKSM;Initial Catalog=Computer_Inventory;Integrated Security=false;User ID=chucks_dev;Password=chuckDbGuy2011;");
			}
		}
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			modelBuilder.Entity<Machine>(entity =>
			{
				...
				entity.Property(e => e.GeneralRole).IsRequired().HasMaxLength(50).IsUnicode(false); // Setting IsUnicode to false make the type varchar, otherwise it will be nvarchar
			...
			{
				entity.Property(e => e.MachineWarrantyId).HasColumnName("MachineWarrntyID");
				entity.Property(e => e.MachineId).HasColumnName("MachineID");
