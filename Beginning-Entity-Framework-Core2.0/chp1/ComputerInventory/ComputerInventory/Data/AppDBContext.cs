...
namespace ComputerInventory.Data
{
	class AppDBContext :DbContext
	{
		...
		public virtual DbSet<MachineType> MachienyType { set; get; }
		...
		protected override void OnConfiguring(DbContextOptionsBuilder optionBuilder)
		{
			if (!optionBuilder.IsConfigured)
			{
				...
				optionBuilder.UseSqlServer(@"Data Source=CHUCKSM;Initial Catalog=Computer_Inventory;Integrated Security=false;User ID=username;Password=password;");
			}
		}
